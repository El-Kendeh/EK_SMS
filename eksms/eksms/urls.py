...
from .views import (
    ...
    api_system_health, api_get_grade_alerts, api_csp_report, api_logs,
    api_test_connection,
    # New endpoints
...
urlpatterns = [
    ...
    path('api/logs',             api_logs),
    path('api/logs/',            api_logs,              name='api_logs'),
    ...
    path('api/school/students',                 api_students),
