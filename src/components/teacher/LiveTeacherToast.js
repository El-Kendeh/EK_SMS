...
import { useTeacherNotifyCtx } from '../../context/TeacherNotificationContext';
import '../common/LiveNotificationToast.css';

export default function LiveTeacherToast({ onOpen }) {
  const { latest, dismissLatest } = useTeacherNotifyCtx();
