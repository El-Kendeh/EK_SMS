...
export const PAGE_PERMISSIONS = {
  ...
  'principal-timetable':     [ROLES.PRINCIPAL, ROLES.SUPERADMIN],
  'principal-teachers':      [ROLES.PRINCIPAL, ROLES.SUPERADMIN],
  ...
  'academic-calendar':    [ROLES.SCHOOL_ADMIN, ROLES.PRINCIPAL],
